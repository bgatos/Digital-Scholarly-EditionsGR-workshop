...
- choose menu 'Document' > 'Schema' > 'Associate schema' and select the file you just downloaded by clicking on the plain folder next to the URL box. Leave the rest as it is and press OK. 
